...
This is an open-source SNMP client library for Go. This allows you to query and set any variable on SNMP servers, given it's OID (no MIB resolution). It is released under the Apache 2.0 licence.
